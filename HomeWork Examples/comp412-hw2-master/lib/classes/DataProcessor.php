...
final class DataProcessor {
	...
	public function loadData() {
		//get the data
		$censusCsvRemote = "http://locahost:3000/homework/comp412/hw2/data/census-data.csv";
		$foodCsvRemote = "http://locahost:3000/homework/comp412/hw2/data/food-inspections.csv";
		$communityIdToZipRemote = "http://locahost:3000/homework/comp412/hw2/data/zip-code-to-community-id.csv";
