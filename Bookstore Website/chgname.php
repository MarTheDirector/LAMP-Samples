...
?><p>				
<b>To change your name fill out the form below:</b>
<table border="0" width="100%" bgcolor="#F0F0F0">
<form name="form1" id="form1" method="POST" action="updatename.php">
<tr><td width="170" align="right">First Name: </td><td><input type="text" name="firstname" size="40" value="<?php print $row['firstname']; ?>" /></td></tr>
<tr><td width="170" align="right">Last Name: </td><td><input type="text" name="lastname" size="40" value="<?php print $row['lastname']; ?>" /></td></tr>
