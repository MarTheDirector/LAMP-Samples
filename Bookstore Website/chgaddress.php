...
<p><b>To change your name fill out the form below:</b>
<table border="0" width="100%" bgcolor="#F0F0F0">
<form name="form1" id="form1" method="POST" action="updateaddress.php">
<tr><td width="170" align="right">Address: </td><td><input type="text" name="address" size="40" value="<?php print $row['address']; ?>" /></td></tr>
<tr><td width="170" align="right">City: </td><td><input type="text" name="city" size="40" value="<?php print $row['city']; ?>" /></td></tr>
<tr><td width="170" align="right">State: </td><td><select name="state" size="1" >
<?php foreach ($usstates as $state) {print '<option value="'.$state.'" '; if($row["state"] == $state){ echo 'selected="selected">';} else{echo ">";}  print ''.$state.' </option>';}?></select></td></tr>
<tr><td width="170" align="right">Zipcode: </td><td><input type="text" name="zipcode" size="40" value="<?php print $row['zipcode']; ?>" /></td></tr>
