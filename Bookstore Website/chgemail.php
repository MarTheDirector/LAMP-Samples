...
?><p>				
<b>To change your email number fill out the form below:</b>
<table border="0" width="100%" bgcolor="#F0F0F0">
<form name="form1" id="form1" method="POST" action="updateemail.php">
<tr><td width="170" align="right">Email Address: </td><td><input type="text" name="email" size="40" value="<?php print $row['email']; ?>" /></td></tr>
