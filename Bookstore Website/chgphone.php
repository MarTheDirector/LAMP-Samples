...
?><p>				
<b>To change your phone number fill out the form below (your old phone number will appear if one was entered before):</b>
<table border="0" width="100%" bgcolor="#F0F0F0">
<form name="form1" id="form1" method="POST" action="updatephone.php">
<tr><td width="170" align="right">Phone Number: </td><td><input type="text" name="phone" size="40" value="<?php print $row['phone']; ?>" /></td></tr>
